...
class BuildExe:
    def __init__(self):
        ...
        # 起始py文件
        self.script = "SnakeGame.py"
        # 游戏名
        self.project_name = "嗷大喵贪吃蛇"
        # 游戏site
        ...
        # 游戏描述
        self.project_description = "贪吃的嗷大喵，嗷大喵版贪吃蛇"
        # 游戏图标(None的话使用pygame的默认图标)
        self.icon_file = None
        # 额外需要拷贝的文件、文件夹(图片，音频等)
        self.extra_datas = ["1.png","2.png","3.png","4.png","5.png","6.png","BGM.ogg","7.png","face.png",'8.png','9.png',"10.png",'11.png','12.png','13.png','14.png','15.png','16.png']
        # 额外需要的python库名
